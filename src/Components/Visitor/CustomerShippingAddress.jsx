    ...
    return ( 
        <div>
            <div className="content">
                <h6>List of shipping addresses I have used</h6>
                <table className="table-content">
                    ...
                    <tbody>
                        {props.shippingAddresses !== undefined &&
                        <React.Fragment>
                            {
                                props.shippingAddresses.map(address =>
                            ...
                            <tr>
                                <td colspan="11">
                                    {props.shippingAddresses.length === 0 && <p style={{textAlign: "center"}}>You have not yet used any shipping address</p>}
                                </td>
                            </tr>
                        </React.Fragment>
                        }
