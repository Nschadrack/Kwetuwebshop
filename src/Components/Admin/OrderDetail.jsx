...
class OrderDetail extends Component {
    ...
    render() {
        if(this.props.OnAnimate){
            orderDetailDiv = <div>
                                <div>
                                    <Title title={"Order Detail"} title2={" / order / order-detail"} OnAnimateTitle={this.props.OnAnimate}/>
                                </div>
                                    ...
                                    <div className="customer-info-detail">
                                        ...
                                        <div className="customer-info-detail-divs">
                                            ...
                                            <React.Fragment>                                                
                                                ...
                                                {this.state.orderdetatil.rejected_date === null && <p><br/></p>}
                                                <p><br/></p>
                                                <p><br/></p>
                                                <p><br/></p>
                                            </React.Fragment>
                                                        ...
                                                        this.state.orderdetatil.ordered_products.map(item=>
                                                            <tr key={item.order_item_id}>
                                                                ...
                                                                <td className="action-buttons">
                                                                    ...
                                                                    to={item.classification==="coffee"? `/admin/kwetu-trade/panel/coffee/detail/${item.product_id}` : item.classification==="material" ?
                                                                    `/admin/kwetu-trade/panel/material/detail/${item.product_id}` : `/admin/kwetu-trade/panel/animal/detail/${item.product_id}`}>
            ...
            orderDetailDiv =<div>
                                <div>
                                    <Title title={"Order Detail"} title2={"/ order / order-detail"}/>
                                </div>
                                <Spring
                                from={{width:'77%'}}
