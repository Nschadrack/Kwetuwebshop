...
class Order extends Component {
    ...
    handleSubmitOrderStatus = (e) =>{
        ...
        if(this.state.orderStatus.length === 0){
            ...
            var url =   `http://50.116.29.247/update/order/${this.state.activeOrder.order_number}/`
    ...
    render() { 
        let currentOrders = this.props.currentOrdersPosts
        ...
        if(this.props.OnAnimate){
            orderDiv = <div>
                            <div>
                                <Title title={"Orders"} title2={" / orders"} OnAnimateTitle={this.props.OnAnimate}/>
                            </div>
                            <div className="main-load-data">
                                ...
                                setPostsPerPage={this.props.setPostsPerPage} currentPosts={this.props.currentOrdersPosts}
                                ...
                                searchingSpecialOrder={this.props.searchingSpecialOrder} category={"order"} searchingInvoice={this.props.searchingInvoice}/>
                                ...
                                {deleteWindow}
                                <Pagination postsPerpage={this.props.OrdersPostsPerPage} totalPosts={this.props.totalOrders} paginate={this.props.paginate}/>
                            </div>
                        </div>
        }
        else{
            orderDiv = <div>
                            <div>
                                <Title title={"Orders"} title2={" / orders"}/>
                            </div>
                            <Spring
                            from={{width:'77%'}}
